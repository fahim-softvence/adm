        ...
        <nav class="breakdown-navbar">
          <div class="breakdown-navbar-wrapper">
            ...
            <ul class="navbar-list-service">
              ...
              <li class="nav-item">
                <a class="nav-link cmn-color-service" href="./service-details.html">
                <Link to="/service">Services</Link>
                  
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link cmn-color-service" href="./index.html#pricing">
                <Link to="/">Pricing</Link>
                  
                </a>
              </li>
              <li class="nav-item">
                <a class="nav-link cmn-color-service" href="./about.html">
